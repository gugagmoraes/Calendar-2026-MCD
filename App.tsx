...
import { Search, Filter, Moon, Sun, Layout, Calendar as CalendarIcon, BookOpen } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between py-4 gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Músculos e Corpo Definido</p>
            </div>
          ...
          {/* Filters Toolbar */}
          <div className="py-3 border-t border-gray-100 dark:border-gray-800 flex flex-wrap gap-3 items-center">
